    ...
    app.controller('rolesManagementCtrl', [
        ...
        function (
            ...
            $scope.editMode = function () {
                ...
                rolesManagementService.getSecUsersListByRole($scope.newSecRole).then(function (response) {
                    refreshUserViewGrid();
            ...
            function createSecRole() {
                ...
                rolesManagementService.createSecRole(data).then(function () {
            ...
            function updateSecRole() {
                ...
                rolesManagementService.updateSecRole(data).then(function () {
                    util.createToast(util.systemMessages.successTransaction, "success");
                    refreshGrid();
                    refreshUserViewGrid();
                    $scope.toggleView();
            ...
            $scope.deleteSecRole = function () {
                ...
                return rolesManagementService.deleteSecRole($scope.selectedSecRole).then(function () {
                    util.createToast(util.systemMessages.successTransaction, "success");
                    refreshGrid();
