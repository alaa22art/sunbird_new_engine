---------MIW 1.2.0 LATESR TESTED ------------------


UPDATE "public"."com_tenant_messages" SET "description"='{"en_us":"© 2019 Optimiza Solutions, All rights reserved.","ar_jo":"جميع الحقوق محفوظة 2019"}' WHERE ("code"='copyrights');
INSERT INTO "public"."com_tenant_messages" ("tenant_id", "created_by", "creation_date", "update_date", "updated_by", "code", "description", "type_id", "version") VALUES ('1', '0', '2018-11-12 13:14:19.674', NULL, NULL, 'mobilePatternHint', '{"en_us":"# for any number, other characters will be static","ar_jo":"# لأي رقم ، ستكون الأحرف الأخرى ثابتة"}', '59', '0');
INSERT INTO "public"."com_tenant_messages" ("tenant_id", "created_by", "creation_date", "update_date", "updated_by", "code", "description", "type_id", "version") VALUES ('0', '0', '2018-11-12 13:14:19.796', '2018-11-12 13:16:34.055', '0', 'mobilePatternHint', '{"en_us":"# for any number, other characters will be static","ar_jo":"# لأي رقم ، ستكون الأحرف الأخرى ثابتة"}', '62', '1');
INSERT INTO "public"."com_tenant_messages" ("tenant_id", "created_by", "creation_date", "update_date", "updated_by", "code", "description", "type_id", "version") VALUES ('1', '0', '2018-11-11 14:26:12.66', NULL, NULL, 'tenantManagement', '{"en_us":"Tenant Management","ar_jo":"إدارة المستأجر"}', '59', '0');
INSERT INTO "public"."com_tenant_messages" ("tenant_id", "created_by", "creation_date", "update_date", "updated_by", "code", "description", "type_id", "version") VALUES ('0', '0', '2018-11-11 14:26:12.711', NULL, NULL, 'tenantManagement', '{"en_us":"Tenant Management","ar_jo":"إدارة المستأجر"}', '59', '0');
INSERT INTO "public"."com_tenant_messages" ("tenant_id", "created_by", "creation_date", "update_date", "updated_by", "code", "description", "type_id", "version") VALUES ('1', '0', '2018-11-12 12:43:08.785', NULL, NULL, 'mobilePattern', '{"en_us":"Mobile Pattern","ar_jo":"نمط المحمول"}', '59', '0');
INSERT INTO "public"."com_tenant_messages" ("tenant_id", "created_by", "creation_date", "update_date", "updated_by", "code", "description", "type_id", "version") VALUES ('0', '0', '2018-11-12 12:43:08.794', NULL, NULL, 'mobilePattern', '{"en_us":"Mobile Pattern","ar_jo":"نمط المحمول"}', '59', '0');
INSERT INTO "public"."com_tenant_messages" ("tenant_id", "created_by", "creation_date", "update_date", "updated_by", "code", "description", "type_id", "version") VALUES ('1', '0', '2018-11-12 13:16:16.844', NULL, NULL, 'output', '{"en_us":"Output","ar_jo":"النتيجة"}', '59', '0');
INSERT INTO "public"."com_tenant_messages" ("tenant_id", "created_by", "creation_date", "update_date", "updated_by", "code", "description", "type_id", "version") VALUES ('0', '0', '2018-11-12 13:16:16.851', NULL, NULL, 'output', '{"en_us":"Output","ar_jo":"النتيجة"}', '59', '0');
INSERT INTO "public"."com_tenant_messages" ("tenant_id", "created_by", "creation_date", "update_date", "updated_by", "code", "description", "type_id", "version") VALUES ('1', '0', '2018-12-03 11:28:47.777', NULL, NULL, 'availableLanguages', '{"en_us":"Available Languages","ar_jo":"اللغات المتوفرة"}', '59', '0');
INSERT INTO "public"."com_tenant_messages" ("tenant_id", "created_by", "creation_date", "update_date", "updated_by", "code", "description", "type_id", "version") VALUES ('0', '0', '2018-12-03 11:28:47.78', NULL, NULL, 'availableLanguages', '{"en_us":"Available Languages","ar_jo":"اللغات المتوفرة"}', '59', '0');
INSERT INTO "public"."com_tenant_messages" ("tenant_id", "created_by", "creation_date", "update_date", "updated_by", "code", "description", "type_id", "version") VALUES ('1', '0', '2018-08-13 11:39:06.645', '2018-09-10 13:22:26.711', '0', 'selectedLanguages', '{"en_us":"Selected Languages","ar_jo":"اللغات المختارة"}', '59', '0');
INSERT INTO "public"."com_tenant_messages" ("tenant_id", "created_by", "creation_date", "update_date", "updated_by", "code", "description", "type_id", "version") VALUES ('0', '0', '2018-08-13 11:39:06.645', NULL, NULL, 'selectedLanguages', '{"en_us":"Selected Languages","ar_jo":"اللغات المختارة"}', '59', '0');
...
INSERT INTO "public"."com_tenant_messages" ("tenant_id", "created_by", "creation_date", "update_date", "updated_by", "code", "description", "type_id", "version") VALUES ('0', '0', '2018-08-15 13:47:34.486', NULL, NULL, 'primary', '{"en_us":"Primary","ar_jo":"أساسي"}', '59', '0');
INSERT INTO "public"."com_tenant_messages" ("tenant_id", "created_by", "creation_date", "update_date", "updated_by", "code", "description", "type_id", "version") VALUES ('1', '0', '2018-08-15 13:47:34.486', '2018-09-10 13:22:26.576', '0', 'primary', '{"en_us":"Primary","ar_jo":"أساسي"}', '59', '0');
INSERT INTO "public"."com_tenant_messages" ("tenant_id", "created_by", "creation_date", "update_date", "updated_by", "code", "description", "type_id", "version") VALUES ('0', '0', '2018-08-09 12:16:23.078', NULL, NULL, 'branches', '{"en_us":"Branches","ar_jo":"الأفرع"}', '59', '0');
INSERT INTO "public"."com_tenant_messages" ("tenant_id", "created_by", "creation_date", "update_date", "updated_by", "code", "description", "type_id", "version") VALUES ('1', '0', '2018-08-09 12:16:23.078', '2018-09-10 13:22:26.603', '0', 'branches', '{"en_us":"Branches","ar_jo":"الأفرع"}', '59', '0');
INSERT INTO "public"."com_tenant_messages" ("tenant_id", "created_by", "creation_date", "update_date", "updated_by", "code", "description", "type_id", "version") VALUES ('0', '3', '2018-05-22 15:18:34.417', NULL, NULL, 'codeExist', '{"en_us":"Code is already used","ar_jo":"الكود مستعمل"}', '61', '0');
INSERT INTO "public"."com_tenant_messages" ("tenant_id", "created_by", "creation_date", "update_date", "updated_by", "code", "description", "type_id", "version") VALUES ('1', '3', '2018-05-22 15:18:34.417', '2018-09-10 13:22:28.255', '0', 'codeExist', '{"en_us":"Code is already used","ar_jo":"الكود مستعمل"}', '61', '0');
INSERT INTO "public"."com_tenant_messages" ("tenant_id", "created_by", "creation_date", "update_date", "updated_by", "code", "description", "type_id", "version") VALUES ('1', '0', '2019-09-24 06:23:31.225', NULL, NULL, 'integrationUrl', '{"en_us":"Integration URL","ar_jo":"Integration URL"}', '59', '0');
INSERT INTO "public"."com_tenant_messages" ("tenant_id", "created_by", "creation_date", "update_date", "updated_by", "code", "description", "type_id", "version") VALUES ('0', '0', '2019-09-24 06:23:31.211', NULL, NULL, 'integrationUrl', '{"en_us":"Integration URL","ar_jo":"Integration URL"}', '59', '0');
...
update mw_machine_order set result_received = 0 where result_received = NULL;


-------------------------------------------------------------------------------------------------
update mw_machine set is_port_open = 0 , connected = 0; 
-------------------------------------------------------------------------------------------------
ALTER TABLE "public"."mw_machine"
ALTER COLUMN "connected" SET NOT NULL,
ALTER COLUMN "is_port_open" SET NOT NULL;
-------------------------------------------------------------------------------------------------
/*
...
Date: 2020-01-20 16:08:02
*/


-- ----------------------------
-- Table structure for mw_machine_type_panel_aud
-- ----------------------------
DROP TABLE IF EXISTS "public"."mw_machine_type_panel_aud";
CREATE TABLE "public"."mw_machine_type_panel_aud" (
"rid " varchar(255) COLLATE "default" NOT NULL,
...
-- ----------------------------
-- Primary Key structure for table mw_machine_type_panel_aud
-- ----------------------------
ALTER TABLE "public"."mw_machine_type_panel_aud" ADD PRIMARY KEY ("rid ", "rev");
...
Date: 2020-01-20 16:07:42
*/


drop sequence if exists lkp_machine_method_seq
create sequence mw_machine_type_panel_seq
 increment 1
 minvalue 1
 maxvalue 9223372036854775807
 start 1
...
-- ----------------------------
-- Table structure for mw_machine_type_panel
-- ----------------------------
DROP TABLE IF EXISTS "public"."mw_machine_type_panel";
CREATE TABLE "public"."mw_machine_type_panel" (
"rid " varchar(255) COLLATE "default" DEFAULT nextval('mw_machine_type_panel_seq'::regclass),
"machine_type_id" int8,
"panel_name" varchar(255) COLLATE "default",
"panel_host_code" varchar(255) COLLATE "default",
"version" int8 NOT NULL,
...
-- ----------------------------
-- Foreign Key structure for table "public"."mw_machine_type_panel"
-- ----------------------------
ALTER TABLE "public"."mw_machine_type_panel" ADD FOREIGN KEY ("machine_type_id") REFERENCES "public"."mw_machine_type" ("rid") ON DELETE NO ACTION ON UPDATE NO ACTION;
