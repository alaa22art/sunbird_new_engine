...
public class AppointmentEntity extends BaseAuditableBranchedEntity implements Serializable
{
    ...
    private String AppointmnetStatus; //=> Open = 1, Close = 2
    ...
    private String OperationType; //InPatient = 1, OutPatient = 2
    @Column(name= "json_appointment")
    private String JSONApointment;
    @Basic(optional = false)
    @Convert(converter = BooleanIntegerConverter.class)
    @Column(name= "is_sent")
    @JsonProperty("IsSent")
