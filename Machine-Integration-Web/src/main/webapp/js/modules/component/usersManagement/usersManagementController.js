    ...
    app.controller('usersManagementCtrl', [
        ...
        function (
            ...
            $scope.userSearchOptions = {
                ...
                skeleton: {
                    code: "username",
                    description: "fullName." + util.userLocale
                },
            ...
            $scope.editMode = function () {
                $scope.groupShuttleBoxOptions.clearSelection();
                $scope.roleShuttleBoxOptions.clearSelection();
                $scope.secUserLKPs[0].setValues($scope.selectedSecUser, $scope.secUserLKPs, {
                    "LabBranch": "rid"
                });
            ...
            function assignLkpsTransField(object) {
                $scope.secUserLKPs[0].assignValues(object, $scope.secUserLKPs, {
                    "LabBranch": "rid"
                });
                return object;
            }
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        template: function (dataItem) {
                            //return '<md-checkbox ng-disabled="true" ng-checked=\"' + item.isActive + '\" aria-label=\"' + item.isActive + '\"></md-checkbox>';
