define(['app', 'util', 'config'], function (app, util, config) {
	'use strict';
	app.controller('loginCtrl', ['$scope', 'loginService', '$state', '$rootScope', '$mdDialog', 'socketService',
		function ($scope, loginService, $state, $rootScope, $mdDialog, socketService) {
			...
			$scope.passwordVisibilityIcon = $scope.isPassVisible ? "fas fa-eye-slash" : "fas fa-eye";
			...
			$scope.forgotPassword = function (ev) {
				$mdDialog.show({
					...
					templateUrl: './' + config.lisDir + '/modules/dialogs/forgotPassword.html',
