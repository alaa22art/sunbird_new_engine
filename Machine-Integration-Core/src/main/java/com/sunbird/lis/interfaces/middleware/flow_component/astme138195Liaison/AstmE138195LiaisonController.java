package com.certacure.lis.interfaces.middleware.flow_component.astme138195Liaison;

import static com.certacure.lis.interfaces.middleware.flow_component.astme138195Liaison.AstmE138195LiaisonProtocol.ACKBytes;
import static com.certacure.lis.interfaces.middleware.flow_component.astme138195Liaison.AstmE138195LiaisonProtocol.ENQBytes;
import static com.certacure.lis.interfaces.middleware.flow_component.astme138195Liaison.AstmE138195LiaisonProtocol.EOTBytes;
...
public class AstmE138195LiaisonController extends FlowComponent<AstmE138195LiaisonControllerConf> {
	...
	private  AstmE138195LiaisonController() {
								...
								.match(LIS2A2QueryMsg.class, __ ->
									{
										...
										System.out.println("Send ENQ as Direct Responce on Query");
									})
								.build();
	}
