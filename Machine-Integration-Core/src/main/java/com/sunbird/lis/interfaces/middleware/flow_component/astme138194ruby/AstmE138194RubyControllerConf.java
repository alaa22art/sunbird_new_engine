...
public class AstmE138194RubyControllerConf implements ConfMsg {
	...
	public AstmE138194RubyControllerConf(int maxFrameSize, ActorRef lowLevelRecipient, ActorRef highLevelRecipient) {
	...
	public static AstmE138194RubyControllerConf create(Config config, ActorContext ctx) {
		...
		return new AstmE138194RubyControllerConf(maxFrameSize, lowLevelRecipient, highLevelRecipient);
	}
}