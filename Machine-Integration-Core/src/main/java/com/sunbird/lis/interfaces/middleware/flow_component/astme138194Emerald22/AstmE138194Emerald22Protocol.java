...
public class AstmE138194Emerald22Protocol {
	...
	public static final BytesMessage CRByte = new BytesMessage((byte) '\r');
	public static final BytesMessage LFByte = new BytesMessage((byte) '\n');
