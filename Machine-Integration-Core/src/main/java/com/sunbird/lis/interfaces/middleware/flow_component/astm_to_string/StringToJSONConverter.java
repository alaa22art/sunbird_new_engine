...
public class StringToJSONConverter extends FlowComponent<RecipientConf> {
    ...
    protected PartialFunction<Object, BoxedUnit> getBehaviour() {
        ...
        return ReceiveBuilder
            ...
            .match(DataInboundTempTable.class, this::convertAndForwardJson)
    ...
    private void convertAndForwardJson(DataInboundTempTable dijm)
    {
        initiateObjects();
        ...
        try {
            System.out.println(
                "\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\");
            System.out.println(dijm.getMessageBody());
            System.out.println(
                "\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\");

            messageTransaction= messageTransactionService.addMessageTransaction(machine,
                dijm.getMessageBody(),
                MessageDirection.IN.toString(), MessageSourceType.JSON_QMS.toString(),MessageSourceType.JSON_QMS.getValue(), false, false,
                false,
                "Arrive new Message", dijm.getMessageControllerId());
            ...
            messageTransaction= messageTransactionService.addMessageTransaction(machine,
                ...
                MessageDirection.IN.toString(), MessageSourceType.JSON_QMS.toString(), MessageSourceType.JSON_QMS.getValue(), false, false,
                false,
                ex.getMessage(),  dijm.getMessageBody());
            httpReqeustTransaction.setMessageTransaction(messageTransaction);

        } finally {
            conf.recipient.tell(httpReqeustTransaction, self());
        }
        conf.recipient.tell(dijm, self());
    }
