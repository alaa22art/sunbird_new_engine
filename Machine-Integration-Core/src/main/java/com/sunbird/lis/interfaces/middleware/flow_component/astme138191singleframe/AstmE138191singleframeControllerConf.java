package com.sunbird.lis.interfaces.middleware.flow_component.astme138191singleframe;
...
public class AstmE138191singleframeControllerConf implements ConfMsg {
	...
	public AstmE138191singleframeControllerConf(int maxFrameSize, ActorRef lowLevelRecipient, ActorRef highLevelRecipient) {
	...
	public String toString() {
		return "AstmE138191singleframeControllerConf{" +
	...
	public static AstmE138191singleframeControllerConf create(Config config, ActorContext ctx) {
		...
		return new AstmE138191singleframeControllerConf(maxFrameSize, lowLevelRecipient, highLevelRecipient);
	}
}