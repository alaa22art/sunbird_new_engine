...
public class DatabaseOutboundEmailSenderController extends FlowComponent<DatabaseOutboundEmailSenderControllerConf> {
    ...
    private DatabaseOutboundEmailSenderController() {
