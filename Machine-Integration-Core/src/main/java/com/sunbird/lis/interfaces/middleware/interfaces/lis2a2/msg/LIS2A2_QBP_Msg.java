...
import com.sunbird.lis.interfaces.middleware.interfaces.lis2a2.record.QueryPatientDemographicRecord;
...
public class LIS2A2_QBP_Msg extends LIS2A2Msg {
	...
	public List<QueryPatientDemographicRecord> getQueryPatientDemographicRecords() {
		return records	.stream()
						.filter(record -> record instanceof QueryPatientDemographicRecord)
						.map(record -> (QueryPatientDemographicRecord) record)
						.collect(Collectors.toList());
	}
