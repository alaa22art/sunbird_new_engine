...
public class AU480ControllerConf implements ConfMsg {
	...
	public AU480ControllerConf(int maxFrameSize, ActorRef lowLevelRecipient, ActorRef highLevelRecipient) {
	...
	public static AU480ControllerConf create(Config config, ActorContext ctx) {
		...
		return new AU480ControllerConf(maxFrameSize, lowLevelRecipient, highLevelRecipient);
	}
}