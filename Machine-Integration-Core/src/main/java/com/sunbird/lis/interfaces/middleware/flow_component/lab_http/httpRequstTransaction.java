...
public class httpRequstTransaction {
    ...
    private String strOldAppointmentID;
    private String strRecivedDateTime;
	...
	public void setOldAppointmentID(String pV1_5_PreadmitNumber) {
		strOldAppointmentID = pV1_5_PreadmitNumber;
	...
	public String getRecivedDateTime() {
		return strRecivedDateTime;
	}

	public void setRecivedDateTime(String recivedDateTime) {
		this.strRecivedDateTime = recivedDateTime;
	}
