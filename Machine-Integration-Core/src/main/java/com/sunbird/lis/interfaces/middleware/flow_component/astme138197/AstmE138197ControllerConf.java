...
public class AstmE138197ControllerConf implements ConfMsg {
	...
	public AstmE138197ControllerConf(int maxFrameSize, ActorRef lowLevelRecipient, ActorRef highLevelRecipient) {
	...
	public String toString() {
		return "AstmE138197ControllerConf{" +
	...
	public static AstmE138197ControllerConf create(Config config, ActorContext ctx) {
		...
		return new AstmE138197ControllerConf(maxFrameSize, lowLevelRecipient, highLevelRecipient);
	}
}