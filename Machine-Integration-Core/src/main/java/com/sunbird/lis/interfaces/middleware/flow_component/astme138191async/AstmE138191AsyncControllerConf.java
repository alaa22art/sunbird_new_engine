...
public class AstmE138191AsyncControllerConf implements ConfMsg {
	...
	public AstmE138191AsyncControllerConf(int maxFrameSize, ActorRef lowLevelRecipient, ActorRef highLevelRecipient) {
	...
	public static AstmE138191AsyncControllerConf create(Config config, ActorContext ctx) {
		...
		return new AstmE138191AsyncControllerConf(maxFrameSize, lowLevelRecipient, highLevelRecipient);
	}
}