...
public class Kx21nControllerConf implements ConfMsg {
	...
	public Kx21nControllerConf(int maxFrameSize, ActorRef lowLevelRecipient, ActorRef highLevelRecipient) {
	...
	public static Kx21nControllerConf create(Config config, ActorContext ctx) {
		...
		return new Kx21nControllerConf(maxFrameSize, lowLevelRecipient, highLevelRecipient);
	}
}