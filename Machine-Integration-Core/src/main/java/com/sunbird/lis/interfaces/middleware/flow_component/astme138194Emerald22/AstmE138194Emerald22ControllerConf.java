...
public class AstmE138194Emerald22ControllerConf implements ConfMsg {
	...
	public AstmE138194Emerald22ControllerConf(int maxFrameSize, ActorRef lowLevelRecipient, ActorRef highLevelRecipient) {
	...
	public static AstmE138194Emerald22ControllerConf create(Config config, ActorContext ctx) {
		...
		return new AstmE138194Emerald22ControllerConf(maxFrameSize, lowLevelRecipient, highLevelRecipient);
	}
}