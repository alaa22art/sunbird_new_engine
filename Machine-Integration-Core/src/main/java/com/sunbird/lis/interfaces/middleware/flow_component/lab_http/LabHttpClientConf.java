...
public class LabHttpClientConf implements ConfMsg {

	public final String resultUrl;
	public final String queryUrl;
	public final ActorRef recipient;

	public LabHttpClientConf(String resultUrl, String queryUrl, ActorRef recipient) {
	...
	public static LabHttpClientConf create(Config config, ActorContext ctx) {
		...
		return new LabHttpClientConf(resultUrl, queryUrl, destination);
	}
}