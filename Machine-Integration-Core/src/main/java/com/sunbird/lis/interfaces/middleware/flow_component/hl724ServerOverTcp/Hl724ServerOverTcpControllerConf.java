package com.sunbird.lis.interfaces.middleware.flow_component.hl724ServerOverTcp;
...
public class Hl724ServerOverTcpControllerConf implements ConfMsg {
	...
	public Hl724ServerOverTcpControllerConf(int maxFrameSize, ActorRef lowLevelRecipient, ActorRef highLevelRecipient) {
	...
	public String toString() {
		return "Hl724ServerOverTcpControllerConf{" + "maxFrameSize=" + maxFrameSize + ", lowLevelRecipient="
	...
	public static Hl724ServerOverTcpControllerConf create(Config config, ActorContext ctx) {
		...
		return new Hl724ServerOverTcpControllerConf(maxFrameSize, lowLevelRecipient, highLevelRecipient);
	}
}