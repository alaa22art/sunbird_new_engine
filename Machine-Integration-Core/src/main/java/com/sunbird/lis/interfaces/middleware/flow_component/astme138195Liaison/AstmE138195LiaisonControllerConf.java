...
public class AstmE138195LiaisonControllerConf implements ConfMsg {
	...
	public AstmE138195LiaisonControllerConf(int maxFrameSize, ActorRef lowLevelRecipient, ActorRef highLevelRecipient) {
	...
	public static AstmE138195LiaisonControllerConf create(Config config, ActorContext ctx) {
		...
		return new AstmE138195LiaisonControllerConf(maxFrameSize, lowLevelRecipient, highLevelRecipient);
	}
}