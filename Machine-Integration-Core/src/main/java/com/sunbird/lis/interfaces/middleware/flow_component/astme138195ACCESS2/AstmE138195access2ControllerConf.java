...
public class AstmE138195access2ControllerConf implements ConfMsg {
	...
	public AstmE138195access2ControllerConf(int maxFrameSize, ActorRef lowLevelRecipient, ActorRef highLevelRecipient) {
	...
	public String toString() {
		return "AstmE138195access2ControllerConf{" +
	...
	public static AstmE138195access2ControllerConf create(Config config, ActorContext ctx) {
		...
		return new AstmE138195access2ControllerConf(maxFrameSize, lowLevelRecipient, highLevelRecipient);
	}
}