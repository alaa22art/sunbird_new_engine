...
public class Hl725ServerOverTcpControllerConf implements ConfMsg {
	...
	public Hl725ServerOverTcpControllerConf(int maxFrameSize, ActorRef lowLevelRecipient, ActorRef highLevelRecipient) {
	...
	public static Hl725ServerOverTcpControllerConf create(Config config, ActorContext ctx) {
		...
		return new Hl725ServerOverTcpControllerConf(maxFrameSize, lowLevelRecipient, highLevelRecipient);
	}
}