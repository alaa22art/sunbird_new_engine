 ...
 * 
 * Eligibility Result {
  "orderId" :int, // Mandatory  Certa_order_id 
  "orderActionId": int, // Mandatory Certa_order_action 
  "orderSource": orderSource, // Mandatory
  "itemCode": string, // Mandatory
  "itemCategoryId": int, // Mandatory
  "isEligible": bool, // Mandatory   
  "quantity": decimal, // Mandatory
  "orderSectionCode": string, // Mandatory
  "description": string,
  "patientInfo": {
    "id": int, // Mandatory
    "code": string, // Mandatory
    "nationalCode": string, // Mandatory
  },
  "visitInfo": {
    "id": int, // Mandatory
     PatientType, // Mandatory
    "sectionCode": string, // Mandatory
    "doctorCode": string, // Mandatory
    "doctoeName": string, // Mandatory
    "admissionReasonCode": string // Mandatory if visit type = admission else not required
     " Appointment " : Bool // mandatory by default False 
}
}
 */

@Entity
@Table(name= "mw_elegabality_approval")
public class ElegabalityApprovalEntity extends BaseAuditableBranchedEntity implements Serializable {
     ...
     *       1.OrderId 
             ...
             18.VisitInfoAdmissionReasonCode 
	...
	public ElegabalityApprovalEntity() {}
