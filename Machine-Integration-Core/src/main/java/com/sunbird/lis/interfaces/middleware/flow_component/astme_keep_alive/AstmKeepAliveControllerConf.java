...
public class AstmKeepAliveControllerConf implements ConfMsg {
	...
	public AstmKeepAliveControllerConf(int maxFrameSize, ActorRef lowLevelRecipient, ActorRef highLevelRecipient) {
	...
	public static AstmKeepAliveControllerConf create(Config config, ActorContext ctx) {
		...
		return new AstmKeepAliveControllerConf(maxFrameSize, lowLevelRecipient, highLevelRecipient);
	}
}