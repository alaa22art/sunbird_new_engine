...
public class AstmE138195C311ControllerConf implements ConfMsg {
	...
	public AstmE138195C311ControllerConf(int maxFrameSize, ActorRef lowLevelRecipient, ActorRef highLevelRecipient) {
	...
	public static AstmE138195C311ControllerConf create(Config config, ActorContext ctx) {
		...
		return new AstmE138195C311ControllerConf(maxFrameSize, lowLevelRecipient, highLevelRecipient);
	}
}