...
public class QueryPatientDemographicRecord extends LIS2A2Record {

	public static QueryPatientDemographicRecord create(int sequenceNumber) {
		return (QueryPatientDemographicRecord) new QueryPatientDemographicRecord().setField(1, Type.QPD.name()).setField(2, String.valueOf(sequenceNumber));
	}

	private QueryPatientDemographicRecord() {
	}

	public QueryPatientDemographicRecord(DelimitedData<Field> data) {
		super(data);
	}
	/*
	public String getPatientID(int componentIndex) {
