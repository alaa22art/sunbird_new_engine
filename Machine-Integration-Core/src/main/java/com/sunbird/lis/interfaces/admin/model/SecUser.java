...
public class SecUser extends BaseAuditableTenantedEntity implements Serializable, UserAccount, UserDetails {
	...
	public Collection<GrantedAuthority> getAuthorities() {
		if (CollectionUtil.isCollectionEmpty(this.privileges)) {
			return new ArrayList<>();
		}
		return this.privileges.stream().map(s -> new SimpleGrantedAuthority(s)).collect(Collectors.toList());
	}
