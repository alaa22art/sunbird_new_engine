...
public class AstmE138195C6000ControllerConf implements ConfMsg {
	...
	public AstmE138195C6000ControllerConf(int maxFrameSize, ActorRef lowLevelRecipient, ActorRef highLevelRecipient) {
	...
	public static AstmE138195C6000ControllerConf create(Config config, ActorContext ctx) {
		...
		return new AstmE138195C6000ControllerConf(maxFrameSize, lowLevelRecipient, highLevelRecipient);
	}
}