...
import static com.certacure.lis.interfaces.middleware.flow_component.astme138195C6000.AstmE138195C6000Protocol.ACKBytes;
import static com.certacure.lis.interfaces.middleware.flow_component.astme138195C6000.AstmE138195C6000Protocol.ENQBytes;
import static com.certacure.lis.interfaces.middleware.flow_component.astme138195C6000.AstmE138195C6000Protocol.EOTBytes;
...
public class AstmE138195C6000Controller extends FlowComponent<AstmE138195C6000ControllerConf> {
	...
	private AstmE138195C6000Controller() {
	...
	private PartialFunction<Object, BoxedUnit> getIdleState() {
		return ReceiveBuilder
								...
								.matchEquals(EOTBytes, __ ->
									{
										System.out.println("ERORR IN TRANSMISSION");
