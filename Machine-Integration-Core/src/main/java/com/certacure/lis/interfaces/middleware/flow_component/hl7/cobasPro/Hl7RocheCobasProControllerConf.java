...
public class Hl7RocheCobasProControllerConf implements ConfMsg {
	...
	public Hl7RocheCobasProControllerConf(int maxFrameSize, ActorRef lowLevelRecipient, ActorRef highLevelRecipient) {
	...
	public static Hl7RocheCobasProControllerConf create(Config config, ActorContext ctx) {
		...
		return new Hl7RocheCobasProControllerConf(maxFrameSize, lowLevelRecipient, highLevelRecipient);
	}
}