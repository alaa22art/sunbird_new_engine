...
public class AstmE138191E411ControllerConf implements ConfMsg {
	...
	public AstmE138191E411ControllerConf(int maxFrameSize, ActorRef lowLevelRecipient, ActorRef highLevelRecipient) {
	...
	public static AstmE138191E411ControllerConf create(Config config, ActorContext ctx) {
		...
		return new AstmE138191E411ControllerConf(maxFrameSize, lowLevelRecipient, highLevelRecipient);
	}
}