...
public class SysmexSuitLIS2A2ToLabConverter extends FlowComponent<RecipientConf> {
	...
	public List<LabResultMsg> lis2a2ResultMsgToLabResultMsgs(LIS2A2ResultMsg Lis2A2ResultMsg) {
		...
		for (PatientRecord patientRecord : Lis2A2ResultMsg.getPatientRecord()) {
						...
						resultRecord ->
							{
								...
								return new Analysis(
										resultRecord.getAnalysisCode(3, 5),
										"",
										"",
										new Result(
												resultRecord.getResultValue(4, 1),
