...
public class AstmE138194ControllerConf implements ConfMsg {
	...
	public AstmE138194ControllerConf(int maxFrameSize, ActorRef lowLevelRecipient, ActorRef highLevelRecipient) {
	...
	public static AstmE138194ControllerConf create(Config config, ActorContext ctx) {
		...
		return new AstmE138194ControllerConf(maxFrameSize, lowLevelRecipient, highLevelRecipient);
	}
}