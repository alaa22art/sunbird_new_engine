...
public class LIS2A2_OUL_Msg extends LIS2A2Msg {

	private long messageTransactionID;

	public LIS2A2_OUL_Msg(List<LIS2A2Record> records) {
		super(records);
	}

	public LIS2A2_OUL_Msg(List<LIS2A2Record> records, long messageTransactionID) {
		super(records);
