...
public class Hl7PureControllerConf implements ConfMsg {
	...
	public Hl7PureControllerConf(int maxFrameSize, ActorRef lowLevelRecipient, ActorRef highLevelRecipient) {
	...
	public static Hl7PureControllerConf create(Config config, ActorContext ctx) {
		...
		return new Hl7PureControllerConf(maxFrameSize, lowLevelRecipient, highLevelRecipient);
	}
}