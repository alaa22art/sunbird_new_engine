...
public class HL723SwelabBM500ControllerConf implements ConfMsg {
	...
	public HL723SwelabBM500ControllerConf(int maxFrameSize, ActorRef lowLevelRecipient, ActorRef highLevelRecipient) {
	...
	public static HL723SwelabBM500ControllerConf create(Config config, ActorContext ctx) {
		...
		return new HL723SwelabBM500ControllerConf(maxFrameSize, lowLevelRecipient, highLevelRecipient);
	}
}