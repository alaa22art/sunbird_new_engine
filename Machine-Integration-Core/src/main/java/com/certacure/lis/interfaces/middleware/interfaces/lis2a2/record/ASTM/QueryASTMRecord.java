...
public class QueryASTMRecord extends LIS2A2Record {

	public static QueryASTMRecord create(int sequenceNumber) {
		return (QueryASTMRecord) new QueryASTMRecord().setField(1, Type.Q.name()).setField(2, String.valueOf(sequenceNumber));
	}

	private QueryASTMRecord() {
	}

	public QueryASTMRecord(DelimitedData<Field> data) {
		super(data);
	}
