 ...
 **/
@Entity
@Table(name = "lkp_order_action_code")
public class LkpOrderActionCode extends BaseAuditableEntity implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		LkpOrderActionCode other = (LkpOrderActionCode) obj;
		if (rid == null) {
			if (other.rid != null)
				return false;
