...
public class AstmE138194BeckmanAccess2ControllerConf implements ConfMsg {
	...
	public AstmE138194BeckmanAccess2ControllerConf(int maxFrameSize, ActorRef lowLevelRecipient, ActorRef highLevelRecipient) {
	...
	public static AstmE138194BeckmanAccess2ControllerConf create(Config config, ActorContext ctx) {
		...
		return new AstmE138194BeckmanAccess2ControllerConf(maxFrameSize, lowLevelRecipient, highLevelRecipient);
	}
}