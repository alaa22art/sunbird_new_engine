...
public class SysmexSuitAstmE138191Controller extends FlowComponent<SysmexSuitAstmE138191ControllerConf> {
	...
	private SysmexSuitAstmE138191Controller() {
	...
	private PartialFunction<Object, BoxedUnit> getSendingState() {
		return ReceiveBuilder
								...
								.match(LIS2A2QueryMsg.class, __ ->
									{
										log.info("WWWWWWWWWWWWWWWWWQQQQQQQQQQQQQQQQWWWWWWWWWWWWWWW");
									})
								.matchAny(__ ->
									{
										stash();
								...
								.match(BytesMessage.class, bytesMessage ->
									{
										...
										log.info(extractPayload(bytesMessage.bytes));
										conf.lowLevelRecipient.tell(ACKBytes, self());
