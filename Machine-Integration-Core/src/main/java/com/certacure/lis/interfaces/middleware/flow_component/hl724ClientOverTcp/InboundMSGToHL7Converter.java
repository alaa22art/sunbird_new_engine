...
import com.certacure.lis.interfaces.middleware.flow_component.scheduler.EligibilityOrderMapper;
...
public class InboundMSGToHL7Converter extends FlowComponent<RecipientConf> {
    ...
    private OutboundHl7MessageSequance ackMessageSequanceObj;
