...
public class SocketServerConf implements ConfMsg {
	...
	public SocketServerConf(String address, int portNumber, String machineName, ActorRef recipientActor) {
	...
	public static SocketServerConf create(Config config, ActorContext ctx) {
		...
		return new SocketServerConf(machine.getServerIpAddress(), machine.getServerPort(), machine.getName(), recipientActor);
	}
