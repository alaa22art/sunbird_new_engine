...
public class HL723VidasLIS2A2ToStringConverter extends FlowComponent<RecipientConf> {
	...
	private void convertAndForward(String strHl7Message) 
	{
		if (!strHl7Message.isEmpty()) {
			//createNewMessageTransactionType(lis2a2Msg, astmMessage, MessageTransactionType.TEST_SELECTION);
		}

		conf.recipient.tell(strHl7Message, self());
	}
