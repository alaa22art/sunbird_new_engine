...
public class PatientRecord extends LIS2A2Record {
	...
	public PatientRecord setDateTimeOfBirth(Date dateTimeOfBirth) {
		return (PatientRecord) setField(7, dateTimeOfBirth.toString());
	}
	...
	public String getDateTimeOfBirth(int index) {
		return this. getFieldValue(index);
	}
	
	public String getCobasProDateTimeOfBirth() {
		return this. getFieldValue(6);
	}
	...
	public PatientRecord setGender(String gender) {
		return (PatientRecord) setField(9, gender);
	}
