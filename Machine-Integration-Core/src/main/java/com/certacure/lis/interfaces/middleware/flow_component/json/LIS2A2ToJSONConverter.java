...
import com.certacure.lis.interfaces.middleware.enums.Enums.DISCHARGE_REASON;
import com.certacure.lis.interfaces.middleware.enums.Enums.ERROR_TYPE;
import com.certacure.lis.interfaces.middleware.enums.Enums.HL7_v24_DFT_P03_TYPE;
import com.certacure.lis.interfaces.middleware.enums.Enums.HTTP_REQUESTED_METHOD_TYPE;
import com.certacure.lis.interfaces.middleware.enums.Enums.PATIENT_CLASS;
...
import com.certacure.lis.interfaces.service.MappingCodesService;
...
// .match(LIS2A2Msg.class, this::convertAndForward)
        ...
        try {
            ...
            if (msgType == null) {
                ...
                */
                ...
                httpRequestObj.getMessageTransaction()
                    .setMessageType(getMessageTypeObj(MessageSourceType.HL7.toString()));
                httpRequestObj.getMessageTransaction().setIsSent(false);
                httpRequestObj.getMessageTransaction().setIsSuccess(false);
                httpRequestObj.getMessageTransaction().setIsValidated(false);
                httpRequestObj.getMessageTransaction()
            ...
            if (msgType == LIS2A2_ADT_Msg.class) {
                ...
                case P03:
                    ...
                    postDetailFinancialTransaction
                        .setAttendingDoctorID(PV1_7_1_AttendingDoctorCode);
                    postDetailFinancialTransaction
                        .setAssignedPatientLocation(PV1_3_AssignedPatient);

                    postDetailFinancialTransaction.setTransactionDate(FT1_4_TransactionDate);
                    postDetailFinancialTransaction
                        .setTransactionPostingDate(FT1_5_TransactionPostingDate);
                    ...
                    postDetailFinancialTransaction
                        .setRCMItemCode(FT1_7_TransactionCode.replaceAll("[^\\d.]", ""));
                    ...
                    case "PSJ":
                    	 ...
                    	 if (FT1_6_TransactionType.equals("PF")) 
                    	 {
                             ...
                             throw new Exception(
                                 "THE ORDER COMPLET MSG (PF) IS Not IMPLEMENTED IN RCM (IGNOR)" +
                                     "," + " VISTA ORDER ID: [" + FT1_2_TransactionID + "]" +
                                       "," + "VISTA ITEM COE: [" + FT1_7_TransactionCode + "]" );
                         }
                            ...
                            if (lisDFTOrders.size() > 0) {
                                ...
                                httpRequestObj.setAPI_URL_PREFIX(
                                    String.format(
                                        API_URL_PREFEX.DETAIL_FINANCIAL_TRANSACTION_COMPLETE
                                            .getValue(),
                                ...
                                httpRequestObj.setReceivingFacility(MSH6_ReceivingFacility);
                            	 ...
                            	 throw new Exception("OPERATION FAILED , CAN NOT COMPLETE ORDER!!," +
                                         "ORDER MEDICATION IS NOT EXISTED [ VISTA ORDER ID:" +
                                         FT1_7_TransactionCode +"], VISTA ORDER ITEM [" + FT1_2_TransactionID +
                                         "]");
                            }

                        } else if (FT1_6_TransactionType.equals("DC") ||
                            FT1_6_TransactionType.equals("CR")) {
                                if (lisDFTOrders.size() > 0) {
                                    ...
                                    httpRequestObj.setAPI_URL_PREFIX(String.format(
                                        API_URL_PREFEX.DETAIL_FINANCIAL_TRANSACTION_PHARMACY_RETURN_DISPENCE
                                            .getValue(),
                                        lisDFTOrders.get(0).getRCMOrderActionID()));
                                    httpRequestObj.setSendingFacility(MSH4_SendingFacility);
                                    httpRequestObj.setReceivingFacility(MSH6_ReceivingFacility);
                                    ...
                                    throw new Exception(
                                        "ERROR:ITEM MEDICATION NOT DISPENCE FOR THIS ORDER [" +
                            ...
                            }  else // if (FT1_6_TransactionType.equals("CH"))
                        {
                            ...
                            httpRequestObj.setAPI_URL_PREFIX(
                                API_URL_PREFEX.DETAIL_FINANCIAL_TRANSACTION_PHARMACY_CREATE
                                    .getValue());
                            httpRequestObj.setHttpMethodType(HTTP_REQUESTED_METHOD_TYPE.POST);
                            httpRequestObj.setSendingFacility(MSH4_SendingFacility);
                            httpRequestObj.setReceivingFacility(MSH6_ReceivingFacility);
                    ...
                    case "RA":
                    	...
                    	if (FT1_6_TransactionType.equals("PF")) 
                    	{
                            ...
                            if (lisDFTOrders.size() > 0) {
                                ...
                                httpRequestObj.getMessageTransaction()
                                .setMessageType(getMessageTypeObj(MessageSourceType.DFT_P03_COMPLETE.toString()));
                                httpRequestObj.getMessageTransaction()
                                .setAdtOperationType(MessageSourceType.DFT_P03_COMPLETE.getValue());

                            } else {
                                throw new Exception(
                                    "OPERATION FAILED!!, ORDER NOT FOUND  [" + FT1_2_TransactionID +
                                        "] , ORDER CAN NOT BE COMPLETED");

                            }

                        } else if (FT1_6_TransactionType.equals("CR") ||
                            FT1_6_TransactionType.equals("DC")) {
                                ...
                                if (lisDFTOrders.size() != 0) {
                                    ...
                                    httpRequestObj.setAPI_URL_PREFIX(
                                        String.format(
                                            API_URL_PREFEX.DETAIL_FINANCIAL_TRANSACTION_CANCEL
                                                .getValue(),
                                            lisDFTOrders.get(0).getRCMOrderActionID()));
                                    httpRequestObj
                                        .setHttpMethodType(HTTP_REQUESTED_METHOD_TYPE.POST);
                                    httpRequestObj.setSendingFacility(MSH4_SendingFacility);
                                    httpRequestObj.setReceivingFacility(MSH6_ReceivingFacility);
                            ...
                            } else // if (FT1_6_TransactionType.equals("CH"))
                        {
                            ...
                            if (strTransactionCodeString == null) {
                                throw new Exception("MAPPING ERROR!!! ," + "ORDER [" + FT1_2_TransactionID +
                                    "]" + " FAILED TO ADD!!!" + "VISTA ORDER ITEM [" +
                            ...
                            strRequest = createNewOrder(httpRequestObj, lisDFTOrders);
           ...
           // httpRequestObj.getMessageTransaction().setNotes(strAllErrors);
            ...
            messageTransactionService.addMessageTransaction(
                ...
                httpRequestObj.getMessageTransaction().getIsSuccess(),
    ...
    private String createNewOrder(httpRequstTransaction httpRequestObj,
        List<PostDetailFinancialTransaction> lisDFTOrders) throws Exception {
        // if(lisDFTOrders.size() == 0)
        // {
        strRequest= getOrderCreateJSON();
        // }else
        // {
        // throw new Exception("ERROR:_ORDER ALREDY CREATED , YOU CAN NOT CREATE
        // AGAIN");
        // }
    ...
    private String getEncounter(String pV1_19_VisitNumber2, String pV1_2) {
        if (pV1_19_VisitNumber2.isEmpty() || pV1_2.isEmpty()) { return ""; }
    ...
    private String adt_a03_CloseVisitRequst() throws Exception {
        ...
        strRequest= "{" + "\r\n" + "\"" + "closeDate" + "\"" + ":" + "\"" +
            ...
            "\"" + ":" + "{" + "\r\n" + "\"" + "code" + "\"" + ":" + "{" + "\r\n" + "\"" + "value" +
            "\"" + ":" + "\"" + EVN5_OperatorID + "\"" + "\r\n" + "}}," + "\"" + "recordedDate" +
            "\"" + ":" + "\"" + getDateTimeISO8601(PV1_45_DischargeDateTime) + "\"" + getRequestedClass(PV1_21_ChargePriceIndicator) + "}";
    ...
    private String siu_s13_UpdateAppointmentRequest() throws Exception {
        String strRequest;
        strRequest= "{\r\n" + "\"" + "appointmentType" + "\"" + ":" + "\"" + PV1_28_InterestCode +
            "\"" + "," + "\r\n" + "\"" + "doctor" + "\"" + ":" + "{" + "\r\n" + "\"" + "code" +
            "\"" + ":" + "{" + "\r\n" + "\"" + "value" + "\"" + ":" + "\"" +
            PV1_7_1_AttendingDoctorCode + "\"" + "\r\n" + "}}," + "\r\n" + "\"" + "end" + "\"" +
            ":" + "\"" + getEndTime(PV1_44_AdmitDateTime) + "\"" + "," + "\r\n" + "\"" +
            "facility" + "\"" + ":" + "{" + "\r\n" + "\"" + "code" + "\"" + ":" + "{" + "\r\n" +
            "\"" + "value" + "\"" + ":" + "\"" + MSH6_ReceivingFacility + "\"" + "\r\n" + "}}," +
            "\r\n" + "\"" + "patient" + "\"" + ":" + "{" + "\r\n" + "\"" + "code" + "\"" + ":" +
            "{" + "\r\n" + "\"" + "value" + "\"" + ":" + "\"" + PID3_PatientIdentifierList + "\"" +
    ...
    private String getRequestedClass(String pV1_21_ChargePriceIndicator2) {
        // TODO Auto-generated method stub
        if (!pV1_21_ChargePriceIndicator2.isEmpty())
            return "," + "\"" + "requestedClass" + "\"" + ":" + "{" + "\r\n" +
            "\"" + "code" + "\"" + ": {" + "\r\n" +
            "\"" + "value" + "\"" + ":" + "\"" + pV1_21_ChargePriceIndicator2 + "\"" + "\r\n" +
            "}" + "\r\n" +
            "}";
        else
            return "";
    ...
    private String adt_a01_CreateAdmissionRequest()throws Exception {
        ...
        getAdmissionDoctor(PV1_17_1_AdmittingDoctorCode) +
        getAttendingDoctor(PV1_7_1_AttendingDoctorCode) +
        getConsultingDoctor(PV1_9_1_ConsultingDoctorCode) +
        getReferringDoctor(PV1_8_1_ReferringDoctorCode) +
        ...
        "\"" + "," + "\"" + "lastName" + "\"" + ":" + "\"" + PID5_4_PatientEnFamilyName + "\"" +
        "," + "\"" + "otherFirstName" + "\"" + ":" + "\"" +
        decodeToArabicName(PID5_5_PatientArFirstName) + "\"" + "," + "\"" + "otherFatherName" +
        "\"" + ":" + "\"" + decodeToArabicName(PID5_6_PatientArSecondName) + "\"" + "," + "\"" +
        "otherMidName" + "\"" + ":" + "\"" + decodeToArabicName(PID5_7_PatientArThirdName) +
        "\"" + "," + "\"" + "otherLastName" + "\"" + ":" + "\"" +
        decodeToArabicName(PID5_8_PatientArFamilyName) + "\"" + "}}" + "," +
	...
	private String getAdmissionDoctor(String pV1_17_1_AdmittingDoctorCode2) {
