...
import com.certacure.lis.interfaces.repo.MessageTransactionRepo;
...
public class MessageTransactionService extends GenericService<MessageTransaction, MessageTransactionRepo> {
	...
	@InterceptorFree
	private MessageTransaction addMessageTransaction(String msgAsString,
	...
	@InterceptorFree
	public MessageTransaction addMessageTransaction(String msgAsString,
	...
	public MessageTransaction addMessageTransaction(Machine machine, String msgAsString, String strDir, String strType,
			...
			String patientID, String nationalID, String responseS , String strBarcode) { // machine, msgAsString
		...
		messageTransaction.setIsSuccess(isProcess);
		messageTransaction.setMessageControlID(msgID);
		messageTransaction.setIsSent(isSent);
