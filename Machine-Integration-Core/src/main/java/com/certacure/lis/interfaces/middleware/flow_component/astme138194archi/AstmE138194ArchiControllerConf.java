...
public class AstmE138194ArchiControllerConf implements ConfMsg {
	...
	public AstmE138194ArchiControllerConf(int maxFrameSize, ActorRef lowLevelRecipient, ActorRef highLevelRecipient) {
	...
	public static AstmE138194ArchiControllerConf create(Config config, ActorContext ctx) {
		...
		return new AstmE138194ArchiControllerConf(maxFrameSize, lowLevelRecipient, highLevelRecipient);
	}
}