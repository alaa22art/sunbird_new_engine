package com.certacure.lis.interfaces.middleware.flow_component.astme138194alinity;
...
public class AstmE138194AlinityControllerConf implements ConfMsg {
	...
	public AstmE138194AlinityControllerConf(int maxFrameSize, ActorRef lowLevelRecipient, ActorRef highLevelRecipient) {
	...
	public static AstmE138194AlinityControllerConf create(Config config, ActorContext ctx) {
		...
		return new AstmE138194AlinityControllerConf(maxFrameSize, lowLevelRecipient, highLevelRecipient);
	}
}