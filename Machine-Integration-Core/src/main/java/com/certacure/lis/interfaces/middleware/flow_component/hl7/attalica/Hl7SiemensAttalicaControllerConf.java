...
public class Hl7SiemensAttalicaControllerConf implements ConfMsg {
	...
	public Hl7SiemensAttalicaControllerConf(int maxFrameSize, ActorRef lowLevelRecipient, ActorRef highLevelRecipient) {
	...
	public String toString() {
		return "Hl7RocheCobasProControllerConf{" +
	...
	public static Hl7SiemensAttalicaControllerConf create(Config config, ActorContext ctx) {
		...
		return new Hl7SiemensAttalicaControllerConf(maxFrameSize, lowLevelRecipient, highLevelRecipient);
	}
}