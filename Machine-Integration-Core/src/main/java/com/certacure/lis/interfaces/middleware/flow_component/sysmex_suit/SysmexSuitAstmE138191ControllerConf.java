...
public class SysmexSuitAstmE138191ControllerConf implements ConfMsg {
	...
	public SysmexSuitAstmE138191ControllerConf(int maxFrameSize, ActorRef lowLevelRecipient, ActorRef highLevelRecipient) {
	...
	public static SysmexSuitAstmE138191ControllerConf create(Config config, ActorContext ctx) {
		...
		return new SysmexSuitAstmE138191ControllerConf(maxFrameSize, lowLevelRecipient, highLevelRecipient);
	}
}