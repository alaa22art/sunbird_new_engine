...
public class ResponceControlParameterRecord extends LIS2A2Record {

	public static ResponceControlParameterRecord create(int sequenceNumber) {
		return (ResponceControlParameterRecord) new ResponceControlParameterRecord().setField(1, Type.RCP.name()).setField(2, String.valueOf(sequenceNumber));
	}

	private ResponceControlParameterRecord() {
	}

	public ResponceControlParameterRecord(DelimitedData<Field> data) {
		super(data);
	}
	...
	protected LIS2A2Record getNew(DelimitedData<Field> data) {
		return new QueryPatientDemographicRecord(data);
	}*/
	...
	@Override
	protected LIS2A2Record getNew(DelimitedData<Field> data) {
		return new ResponceControlParameterRecord(data);
	}
}