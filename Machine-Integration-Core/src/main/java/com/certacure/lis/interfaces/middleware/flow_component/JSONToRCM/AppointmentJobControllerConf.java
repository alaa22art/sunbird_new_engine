...
public class AppointmentJobControllerConf implements ConfMsg {
	...
	public AppointmentJobControllerConf(int maxFrameSize, ActorRef lowLevelRecipient, ActorRef highLevelRecipient) {
	...
	public String toString() {
		return "JSONAppointmentControllerConf{" + "maxFrameSize=" + maxFrameSize + ", lowLevelRecipient="
	...
	public static AppointmentJobControllerConf create(Config config, ActorContext ctx) {
		...
		return new AppointmentJobControllerConf(maxFrameSize, lowLevelRecipient, highLevelRecipient);
	}
}