...
public class HL723VidasControllerConf implements ConfMsg {
	...
	public HL723VidasControllerConf(int maxFrameSize, ActorRef lowLevelRecipient, ActorRef highLevelRecipient) {
	...
	public static HL723VidasControllerConf create(Config config, ActorContext ctx) {
		...
		return new HL723VidasControllerConf(maxFrameSize, lowLevelRecipient, highLevelRecipient);
	}
}