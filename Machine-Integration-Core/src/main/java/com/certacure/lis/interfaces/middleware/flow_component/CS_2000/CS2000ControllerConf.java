...
public class CS2000ControllerConf implements ConfMsg {
	...
	public CS2000ControllerConf(int maxFrameSize, ActorRef lowLevelRecipient, ActorRef highLevelRecipient) {
	...
	public static CS2000ControllerConf create(Config config, ActorContext ctx) {
		...
		return new CS2000ControllerConf(maxFrameSize, lowLevelRecipient, highLevelRecipient);
	}
}