...
public class HL7231DymindDH76LIS2A2ToLabConverter extends FlowComponent<RecipientConf> {
						...
						resultRecord ->
							{
								...
								return new Analysis(
										resultRecord.getHL7AnalysisCode(4, 2, "^"),
										"",
										"",
										new Result(
				...
				LabResultMsg labResultMsg = new LabResultMsg(
						new Order(
								new Patient(
										...
										""),
								(new Container(
										orderRecord.getSpecimenIds(1,4).toString().trim(),
										analyses, "", "", "", "", "", "")),
				...
				LabResultMsg labResultMsg = new LabResultMsg(
						new Order(
								new Patient(
										...
										""),
								(new Container(
										orderRecord.getSpecimenIds(3).toString().trim(),
										analyses, "", "", "", "", "", "")),
								"", "", null, Lis2A2ResultMsg.getMessageTransactionID(),"",""));
				result.add(labResultMsg);
