...
public class LIS2A2ResultMsg extends LIS2A2Msg {
	...
	public List<HL7_V24_PatientRecord> getPatientRecords() {
		return records	.stream()
	...
	public List<HL7_V24_OrderRecord> getOrderRecords() 
	{
		return getRecords(HL7_V24_OrderRecord.class);
	}
	
	public List<HL7_V24_OrderRecord> getOrderRecords(HL7_V24_PatientRecord patientRecord) {
		return getRecords(patientRecord, HL7_V24_OrderRecord.class);
	}
	...
	public List<HL7_V24_ResultRecord> getResultRecords(HL7_V24_OrderRecord orderRecord) {
		return getRecords(orderRecord, HL7_V24_ResultRecord.class);
	}
	
	public List<HL7_V24_ResultRecord> getResultRecords( ) {
		return getRecords( HL7_V24_ResultRecord.class);
	}
	
	public List<HL7_V24_ResultRecord> getResultRecords(OrderRecord orderRecord) {
		return getRecords(orderRecord, HL7_V24_ResultRecord.class);
	}
	...
	public List<HL7_V24_SpecimenRecord> getSpecimenRecord() 
	{
		return getRecords(HL7_V24_SpecimenRecord.class);
	}
